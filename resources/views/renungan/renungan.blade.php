...
@section('content')
    ...
    {{-- button Tambah Data --}}
    <div>
        <a href="{{ route('renungan.show') }}" class="btn btn-primary active md-5 mb-3"><i class="bi bi-plus me-1"></i>Tambah
            Data</a>
        <a href="renungan-pdf" class="btn btn-success active md-5 mb-3"><i
            ...
            @foreach ($renungan as $r)
                <tr>
                    ...
                    <td class="d-flex align-items-center justify-content-center gap-2">
                        <a href="{{ route('renungan.edit', $r->id) }}"><button class="btn btn-info btn-sm me-1"><i
                                    class="bi bi-pencil-square me-1"></i>Edit</a>
                        <a href="{{ route('renungan.destroy', $r->id) }}" title="Hapus"><button
