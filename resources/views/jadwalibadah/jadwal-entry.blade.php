        ...
        <div class="form-add p-4 bg-white rounded-4">
            <form action="{{ route('jadwal.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control input" name="nama" id="nama" placeholder="Masukan nama ibadah">
                </div>
                <div class="mb-4">
                    <label for="tempat" class="form-label">Tempat</label>
                    <textarea class="form-control input" name="tempat" id="tempat" rows="5" placeholder="Masukkan nama tempat"></textarea>
                </div>
                <div class="mb-4">
                    <label for="tanggal" class="form-label">Tanggal</label>
                    <input type="datetime-local" class="form-control input" name="tanggal" id="Tanggal"
                        placeholder="Masukan Tanggal Ibadah">
                </div>
                <div class="mb-4">
                    <label for="bacaan" class="form-label">Bacaan<span>*</span></label>
                    <input type="text" class="form-control input" name ="bacaan" id="bacaan" placeholder="Masukan Bacaan Renungan">
                </div>
                <div>
