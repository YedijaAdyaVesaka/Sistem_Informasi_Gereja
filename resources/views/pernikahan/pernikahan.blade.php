...
@section('content')
    ...
    {{-- button Tambah Data --}}
    <div>
        <a href="{{ route('pernikahan.show') }}" class="btn btn-primary active md-5 mb-3"><i
                class="bi bi-plus me-1"></i>Tambah Data</a>
        <a href="pernikahan-pdf" class="btn btn-success active md-5 mb-3"><i
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="d-flex align-items-center justify-content-center gap-2">
                    <a href="{{ route('pernikahan.edit', $p->id) }}"><button class="btn btn-info btn-sm me-1"><i
                                class="bi bi-pencil-square me-1"></i>Edit</a>
                    <a href="{{ route('pernikahan.destroy', $p->id) }}" title="Hapus"><button class="btn btn-danger btn-sm"><i
